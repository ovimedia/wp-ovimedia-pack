...
<div id="floating_widget_container" class="tab_content">
	...
	<p><label for="floating_widget_rotated"><?php echo translate( 'Rotate Widget Button:', 'wp-ovimedia-pack' ); ?></label>
		...
		<select id="floating_widget_rotated" name="floating_widget_rotated" >
			...
			<?php
				echo "<option value='no' ";                             
					...
					if($this->wop_options['floating_widget_rotated'] == "no") 
						echo ' selected="selected" '; 

				echo ">".translate( 'No', 'wp-ovimedia-pack' )."</option>"; 
				...
				echo ">".translate( 'Yes', 'wp-ovimedia-pack' )."</option>"; 
